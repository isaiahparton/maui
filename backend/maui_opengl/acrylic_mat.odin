...
draw_acrylic_mat :: proc(mat: maui.Acrylic_Material, box: maui.Box) {
	...
	*/
	{
		...
		gl.DrawBuffer(gl.COLOR_ATTACHMENT0)
		gl.Viewport(0, 0, ctx.screen_size.x / BLUR_SCALE_FACTOR, ctx.screen_size.y / BLUR_SCALE_FACTOR)
		scaled_box: Box = {box.low / BLUR_SCALE_FACTOR, box.high / BLUR_SCALE_FACTOR}
	...
	*/
	...
	gl.BlitFramebuffer(0, 0, ctx.screen_size.x / BLUR_SCALE_FACTOR, ctx.screen_size.y / BLUR_SCALE_FACTOR, 0, 0, ctx.screen_size.x, ctx.screen_size.y, gl.COLOR_BUFFER_BIT, gl.LINEAR)
	// We're done here
